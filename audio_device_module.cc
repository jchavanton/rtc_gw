...
int32_t FileAudioDevice::RegisterAudioCallback(webrtc::AudioTransport* audio_callback) {
      Audio_device_buffer_->RegisterAudioCallback(audio_callback);
      return 0;
}
...
int32_t FileAudioDevice::StereoPlayoutIsAvailable(bool* available) const {
  *available = true;
  return 0;
}
...
int32_t FileAudioDevice::StereoRecordingIsAvailable(bool* available) const {
  *available = true;
  return 0;
}
